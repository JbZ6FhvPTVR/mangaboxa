...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Hachiraw = exports.HachirawInfo = void 0;
const types_1 = require("@paperback/types");
const entities_1 = require("entities");
const MangaBox_1 = require("../MangaBox");
const MangaBoxHelpers_1 = require("../MangaBoxHelpers");
const SITE_DOMAIN = 'https://hachiraw.net/';
exports.HachirawInfo = {
    version: (0, MangaBox_1.getExportVersion)('0.0.3'),
    name: 'Hachi',
    icon: 'icon.png',
    author: 'Batmeow',
    authorWebsite: 'https://hachiraw.net/',
...
class Hachiraw extends MangaBox_1.MangaBox {
    constructor() {
        super(...arguments);
        // Website base URL.
